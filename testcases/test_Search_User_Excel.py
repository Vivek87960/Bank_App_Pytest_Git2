...
class Test_Search_User_Excel:
    ...
    def test_search_user_Excel_006(self, setup):
        ...
        for r in range(2, self.row_count + 1):
            ...
            self.ExpectedResult = XLutilities.ReadData(self.Excel_file_Path, "SearchUser", r, 3)
            self.su.Click_Link_User_Management()
            ...
            if self.su.Validate_Search_User() == "pass" and self.ExpectedResult == "pass":
                actual_result = XLutilities.WriteData(self.Excel_file_Path, "SearchUser", r, 4, "pass")
                Stauts = XLutilities.WriteData(self.Excel_file_Path, "SearchUser", r, 5, "pass")
                Stauts_List.append("pass")
                # assert True
            elif self.su.Validate_Search_User() == "pass" and self.ExpectedResult == "fail":
                actual_result = XLutilities.WriteData(self.Excel_file_Path, "SearchUser", r, 4, "pass")
                Stauts = XLutilities.WriteData(self.Excel_file_Path, "SearchUser", r, 5, "fail")
                Stauts_List.append("fail")
                # assert False
            elif self.su.Validate_Search_User() == "fail" and self.ExpectedResult == "pass":
                actual_result = XLutilities.WriteData(self.Excel_file_Path, "SearchUser", r, 4, "fail")
                Stauts = XLutilities.WriteData(self.Excel_file_Path, "SearchUser", r, 5, "fail")
                Stauts_List.append("fail")
            # assert False
